...
adminip=$( curl -sS https://raw.githubusercontent.com/Internetvps/allow/main/adminipvps | grep $MYIP )
...
links3="sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/Internetvps/multi/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh"
...
clear
echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m         MENU ADD IP multi WS         \E[0m"
echo -e "\033[0;34m------------------------------------------\033[0m"
echo ""
